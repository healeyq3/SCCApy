...
class Problem:
    ...
    def solve(self, eps: float=1e-3, timeout: float=10,
                lower_bound_func: Callable[[ProblemData], Tuple[float, float]] = None,
        ...
        lb, _ = lower_bound_func(self.data)
        _, fixed_vars, var_scores, var_fixing_time = var_fix(self.data, lb)
